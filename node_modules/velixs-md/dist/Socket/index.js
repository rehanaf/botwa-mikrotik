...
exports.onConnecting = exports.onDisconnected = exports.onConnected = exports.onQRUpdated = exports.onMessageReceived = exports.loadSessionsFromStorage = exports.getSession = exports.getAllSession = exports.deleteSession = exports.startWhatsapp = exports.startSession = void 0;
...
const startSession = (sessionId = "session1", options = { printQR: true }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            sock.ev.process((events) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (events["messages.upsert"]) {
                    const msg = (_h = events["messages.upsert"]
                        .messages) === null || _h === void 0 ? void 0 : _h[0];
                    ...
                    (_j = callback.get(Defaults_1.CALLBACK_KEY.ON_MESSAGE_RECEIVED)) === null || _j === void 0 ? void 0 : _j(Object.assign({}, msg));
                }
            }));
            return sock;
        }
